...
import { selectUserPreferences, togglePopup } from "@/components/userPreferences/userPreferencesSlice";
...
const HeaderPreferences: FC = () => {
    ...
    return (
        <div onClick={() => dispatch(togglePopup())} className={styles.preferences}>
