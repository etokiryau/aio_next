                ...
                <div className={styles.advantages__content}>
                    <section className={styles.advantages__toggler}>
                        <div 
                            ...
                            className={designSection ? styles.activeSection : ''}
                        >
                            Design
                        </div>
                        <div 
                    ...
                    <>
                        <section className={styles.advantages__block}>
                            <h2>Design Small description why it is important</h2>
                            <div className={styles.advantages__block_columns}>
                                <div className={styles.advantages__block_columns_left}>
                                    <div className={styles.advantages__block_columns_left_icon}>
                                        <ShareIcon />
                                    </div>
                                    <div>
                                ...
                                <div className={styles.advantages__block_columns_right}>
                    ...
                    <>
                        <section className={styles.advantages__block}>
                            <h2>Construction Small description why it is important</h2>
                            <div className={styles.advantages__block_columns}>
                                <div className={styles.advantages__block_columns_left}>
                                    <div className={styles.advantages__block_columns_left_icon}>
                                        <ShareIcon />
