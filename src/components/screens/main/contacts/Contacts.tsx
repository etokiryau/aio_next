...
import ClipIcon from "@/components/ui/_icons/ClipIcon";
		...
		<MainLayout title="Contacts">
			<div className={styles.contacts}>
				...
				<section className={styles.contacts__wrapper}>
					<h2>
						Learn more about AIO, visit our social media and feel
						free to contact us!
					</h2>
					<div className={styles.contacts__content}>
						<div className={styles.contacts__content_left}>
							<div
								className={
									styles.contacts__content_left_single_wrapper
								}
							>
								<div
									className={
										styles.contacts__content_left_single
									}
								>
									<div
										className={
											styles.contacts__content_left_single_left
										}
									>
										<div>
											<MailIcon />
									...
									<div
										className={
											styles.contacts__content_left_single_right
										}
									>
										<div>
											<ClipIcon />
						...
						<div className={styles.contacts__content_right}>
							<div
								className={
									styles.contacts__content_right_wrapper
								}
							>
								<div
									className={
										styles.contacts__content_right_address
									}
								>
									<p>
										Rua de Santos Pousada 640, Porto 4000,
										Portugal
									</p>
								</div>
								<div
									className={
										styles.contacts__content_right_links
									}
								>
									<Link
										href="/questiones"
										className={
											styles.contacts__content_right_links_single
										}
									>
										<p>FAQ</p>
										<ArrowLarge />
